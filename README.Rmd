...
## See Also
The `jti`, https://github.com/mlindsk/jti, package (on CRAN) implements belief propagation via the Junction Tree Algorithm which relies heavily on `sparta` tables for extremely fast operations.
